...
st.plotly_chart(fig_stage, use_container_width=True)  # This line was using 'patent_stage' which was undefined. Changed to 'fig_stage' which is the correct variable.
